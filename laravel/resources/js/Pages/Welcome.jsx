                    ...
                    <div className="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                        ...
                        <main className="mt-6">
                            ...
                            <div className="text-center mt-24 mb-40">
                                        ...
                                        A Direção Regional de Educação (DRE) é o serviço da administração direta da Região Autónoma da Madeira integrado na Secretaria Regional de Educação, Ciência e Tecnologia (SRE), que promove, desenvolve, aplica e presta apoio às políticas educativas no âmbito pedagógico e didático da educação pré-escolar, dos ensinos básico e secundário, da educação extraescolar e da educação especial de toda a Região. Dentro da estrutura administrativa da DRE encontra-se a Direção de Serviços de Apoio à Gestão e Organização (DSAGO), que por sua vez integra o Núcleo de Equipamento e Conservação (NEC).
                                        </p>
                                        <a href='https://www.madeira.gov.pt/dre'> <button className="mt-10 bg-gradient-to-b from-sky-500 to-sky-800 hover:from-sky-400 hover:to-sky-700 text-sm text-white shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] font-bold py-5 px-28 rounded-lg tracking-widest uppercase">
                                            Visitar site
                                        </button> </a>
                            </div>

                            <div className='bg-white shadow-[0px_14px_34px_0px_rgba(0,0,0,0.1)] rounded-lg mt-60 mb-60'>
                        ...
                        <footer className="py-16 text-center border-t border-gray-300 mt-10">
                            ...
                            <div className='text-base flex flex-col md:flex-row justify-center mb-10 gap-1 w-2/4 mx-auto text-gray-800'>
                                <a className='basis-1/3 grow-0 hover:underline hover:text-gray-500' href='https://canaldenuncias.madeira.gov.pt/'>
                                    Canal de Denúncias
                                </a>
                                <a className='basis-1/3 grow-0 hover:underline hover:text-gray-500' href='mailto:rgpd.dre@madeira.gov.pt'>
                                    Ponto de Contacto RGPD
                                </a>
                                <a className='basis-1/3 grow-0 hover:underline hover:text-gray-500' href='https://privacidade.madeira.gov.pt/'>
