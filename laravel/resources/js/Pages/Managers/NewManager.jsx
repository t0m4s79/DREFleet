...
export default function NewManager( {auth, users, flash} ) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('managers.create'));
    };

    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Novo Gestor</h2>}
        >
            
            {<Head title='Criar Gestor' />}
                ...
                <div className="max-w-7xl mx-auto my-4 sm:px-6 lg:px-8">
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div className='p-6'>
                            ...
                            <h2>Criar gestor a partir de utilizador existente</h2>
