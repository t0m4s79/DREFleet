...
export default function ShowApprovedOrders({ auth, orders, userId, userName, permissions }) {
    ...
    const ApprovedOrderColumns = [
        ...
        },
        {
            ...
            valueGetter: (params) => {
                ...
                return parse(params, 'yyyy-MM-dd HH:mm:ss', new Date());
            },
        },
    ]
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Pedidos Aprovados por {userName} (#{userId})</h2>}
        >
