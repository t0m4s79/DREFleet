...
export default function AllUsersNotAssigned({ auth, users, flash }) {
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Por Artibuir</h2>}
        >

            <Head title="Por Artibuir" />
