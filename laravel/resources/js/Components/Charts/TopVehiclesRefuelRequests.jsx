...
export default function TopVehiclesRefuelRequests({ refuelRequests }) {
    const uniqueVehicles = parseTopRequestVehicles(refuelRequests);
    ...
    return (
        <ChartContainer className="bg-white overflow-hidden shadow-sm sm:rounded-lg border-l-8 border-sky-600">
            ...
            <BarChart
                ...
                series={[
                    { data: uniqueVehicles.map(v => v.total_requests), label: "Registos de Abastecimento", color: "#0EA5E9", yAxisKey: "leftAxis" },
