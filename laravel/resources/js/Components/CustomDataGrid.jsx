...
export default function CustomDataGrid({ rows, columns, columnVisibility, getRowClassName, editAction, deleteAction, duplicateAction }) {
    ...
    if (editAction || deleteAction || duplicateAction) {
        columns.push({
            field: 'actions',
            headerName: 'Ações',
            hideable: false,
